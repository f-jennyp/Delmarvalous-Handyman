		...
		<div class="row">
			...
			<div class="services-con">
				...
				<ul>
					...
					<li>Furniture Repair and Assembly​</li>
					...
					<li>Drywall Repair / Installation​</li>
					<li>Power Washing</li>
					<li>Electrical and Plumbing</li>
					<li>Deck Installation</li>
					<li>Custom Cabinetry</li>
					<li>Flooring Refinishing</li>
					<li>AND MANY MORE!</li>
				</ul>
			...
			<div class="review-con flex">
				<div class="left">
					...
					<div class="remarks">Brian was outstanding on what was a major remodel of a bathroom. We were moving
						...
						exceeded our expectations. The quality of work was superior, and the project was completed on
						time. Brian was also very personable and explained the process every step of the job. We would
						recommend Brian for any home improvement project, large or small</div>

					<div class="btn-holder">
						<div class="btn">
							<a href="<?php echo URL ?>reviews#content">READ MORE</a>
						</div>
					</div>
